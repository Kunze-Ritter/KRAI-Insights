#!/usr/bin/env bash
# Import bigtables_multirow.sql (Multi-Row INSERTs of ACCSNMPHISTORY +
# ACCMIBCOUNTERVALUES) into DevFleetMgmt.

set -euo pipefail

SCRIPTDIR="/scripts"
LOGDIR="/tmp"
DATAFILE="${SCRIPTDIR}/bigtables_multirow.sql"
TS="$(date +%Y%m%d_%H%M%S)"
LOG="${LOGDIR}/import_multirow_${TS}.log"
PROGRESS="${LOGDIR}/import_multirow_${TS}.progress"
